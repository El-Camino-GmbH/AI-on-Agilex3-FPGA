// ai_control_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_4m4l4ya.v

// Generated using ACDS version 25.3 109

`timescale 1 ps / 1 ps
module ai_control_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_4m4l4ya #(
		...
		input  wire [4:0]   in_channel,        //          .channel,       Channel input port of Avalon Streaming Sink Interface
		...
		output wire [4:0]   out_channel        //          .channel,       Channel output port of Avalon Streaming Source Interface
	);
	...
	ai_control_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_channel        (in_channel),        //   input,    width = 5,          .channel
		...
		.out_channel       (out_channel),       //  output,    width = 5,          .channel
