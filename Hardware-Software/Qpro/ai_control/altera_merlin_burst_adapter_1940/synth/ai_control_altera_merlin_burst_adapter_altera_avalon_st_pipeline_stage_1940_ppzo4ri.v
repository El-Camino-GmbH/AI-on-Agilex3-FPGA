// ai_control_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_ppzo4ri.v

// Generated using ACDS version 25.3 109

`timescale 1 ps / 1 ps
module ai_control_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_ppzo4ri #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 165,
		...
		input  wire [164:0] in_data,           //          .data,          Input Data port of Avalon Streaming Sink Interface
		input  wire [3:0]   in_channel,        //          .channel,       Channel input port of Avalon Streaming Sink Interface
		...
		output wire [164:0] out_data,          //          .data,          Output Data port of Avalon Streaming Source Interface
		output wire [3:0]   out_channel        //          .channel,       Channel output port of Avalon Streaming Source Interface
	);

	ai_control_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),           //   input,  width = 165,          .data
		.in_channel        (in_channel),        //   input,    width = 4,          .channel
		...
		.out_data          (out_data),          //  output,  width = 165,          .data
		.out_channel       (out_channel),       //  output,    width = 4,          .channel
