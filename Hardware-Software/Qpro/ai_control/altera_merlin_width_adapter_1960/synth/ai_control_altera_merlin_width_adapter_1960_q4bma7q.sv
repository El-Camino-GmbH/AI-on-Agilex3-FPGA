...
module ai_control_altera_merlin_width_adapter_1960_q4bma7q 
#(
    ...
    parameter IN_PKT_USER_DATA_H            = 113, 
     //ACE5-Lite signals
    parameter IN_PKT_AWATOP_L               = 154,
    parameter IN_PKT_AWATOP_H               = 159,
    parameter IN_PKT_AWSTASHNID_L           = 160,
    parameter IN_PKT_AWSTASHNID_H           = 170,
    parameter IN_PKT_AWSTASHNIDEN           = 171,
    parameter IN_PKT_AWSTASHLPID_L          = 172,
    parameter IN_PKT_AWSTASHLPID_H          = 176,
    parameter IN_PKT_AWSTASHLPIDEN          = 177,
    parameter IN_PKT_MMUSECSID              = 178,
    parameter IN_PKT_MMUSID_L               = 179,
    parameter IN_PKT_MMUSID_H               = 195,
    parameter IN_PKT_DATALESS               = 196,
    ...
    parameter OUT_PKT_USER_DATA_H           = 87, 
     //ACE5-Lite signals
    parameter OUT_PKT_AWATOP_L              = 154,
    parameter OUT_PKT_AWATOP_H              = 159,
    parameter OUT_PKT_AWSTASHNID_L          = 160,
    parameter OUT_PKT_AWSTASHNID_H          = 170,
    parameter OUT_PKT_AWSTASHNIDEN          = 171,
    parameter OUT_PKT_AWSTASHLPID_L         = 172,
    parameter OUT_PKT_AWSTASHLPID_H         = 176,
    parameter OUT_PKT_AWSTASHLPIDEN         = 177,
    parameter OUT_PKT_MMUSECSID             = 178,
    parameter OUT_PKT_MMUSID_L              = 179,
    parameter OUT_PKT_MMUSID_H              = 195,
    parameter OUT_PKT_DATALESS             = 196,
...
( 
    ...
    localparam IN_AWATOP_W      = IN_PKT_AWATOP_H - IN_PKT_AWATOP_L + 1 ;
    localparam IN_AWSTASHNID_W  = IN_PKT_AWSTASHNID_H - IN_PKT_AWSTASHNID_L + 1 ;
    localparam IN_AWSTASHLPID_W = IN_PKT_AWSTASHLPID_H - IN_PKT_AWSTASHLPID_L + 1 ;
    localparam IN_MMUSID_W      = IN_PKT_MMUSID_H - IN_PKT_MMUSID_L + 1 ;
    ...
    localparam IN_FIRST_L   = 0,
               ...
               OUT_LAST_W  = OUT_LAST_H  - OUT_LAST_L  + 1 ;
    ...
    reg [5:0]             in_awatop_field ;
    reg [10:0]            in_awstashnid_field ;
    reg                   in_awstashniden_field ;
    reg [4:0]             in_awstashlpid_field ;
    reg                   in_awstashlpiden_field ;
    reg                   in_awmmusecsid_field ;
    reg [IN_MMUSID_W-1:0] in_awmmusid_field  ;
    reg                   in_dataless_txn_field  ;
    ...
    always @* begin
       ...
       if(ENABLE_AXI5)begin
        ...
        in_awatop_field        = in_data[IN_PKT_AWATOP_H:IN_PKT_AWATOP_L];
        in_awstashnid_field    = in_data[IN_PKT_AWSTASHNID_H:IN_PKT_AWSTASHNID_L];
        in_awstashniden_field  = in_data[IN_PKT_AWSTASHNIDEN];
        in_awstashlpid_field   = in_data[IN_PKT_AWSTASHLPID_H:IN_PKT_AWSTASHLPID_L];
        in_awstashlpiden_field = in_data[IN_PKT_AWSTASHLPIDEN];
        in_awmmusecsid_field   = in_data[IN_PKT_MMUSECSID];
        in_awmmusid_field      = in_data[IN_PKT_MMUSID_H:IN_PKT_MMUSID_L]; 
        in_dataless_txn_field  = in_data[IN_PKT_DATALESS] ;
    end
   ...
   logic [LAST_W-OUT_LAST_W-1:0] tmp_last;
   always @* begin
      if (FIRST_EXISTS)
      ...
      if (LAST_EXISTS)
          {tmp_last, out_data[OUT_LAST_H:OUT_LAST_L]}  = out_last_field; 
      ...
      out_data[OUT_PKT_AWATOP_H:OUT_PKT_AWATOP_L]           = in_awatop_field;
      out_data[OUT_PKT_AWSTASHNID_H:OUT_PKT_AWSTASHNID_L]   = in_awstashnid_field;
      out_data[OUT_PKT_AWSTASHNIDEN]                        = in_awstashniden_field;
      out_data[OUT_PKT_AWSTASHLPID_H:OUT_PKT_AWSTASHLPID_L] = in_awstashlpid_field;
      out_data[OUT_PKT_AWSTASHLPIDEN]                       = in_awstashlpiden_field;
      out_data[OUT_PKT_MMUSECSID]                           = in_awmmusecsid_field;
      out_data[OUT_PKT_MMUSID_H:OUT_PKT_MMUSID_L]           = in_awmmusid_field; 
      out_data[OUT_PKT_DATALESS]                            = in_dataless_txn_field;
   end // always @ *
