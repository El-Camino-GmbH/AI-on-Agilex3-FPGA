...
ARCHITECTURE BEHAVIORAL OF CNN IS
    ...
    SIGNAL oData_Filter_2 : CNN_Values_T(0 downto 0);
    ...
    SIGNAL oStream_Conv_9 : CNN_Stream_T;
    SIGNAL oData_Conv_9 : CNN_Values_T(0 downto 0);
...
BEGIN
    ...
    oStream_Filter_2 <= oStream_Filter_1;
    oData_Filter_2(0) <= oData_Filter_1(0);

    Inverse_Filter_Out : Inverse_Filter
    GENERIC MAP (
        Input_Values   => 1,
        Input_Images   => 1,
        En_In_Buffer   => TRUE,
        ...
        oStream        => oStream_Filter_Out,
        oData          => oData_Filter_Out
    );
    ...
    GENERIC MAP (
        ...
        iStream        => oStream_Conv_8,
        iData          => oData_Conv_8,
        oStream        => oStream_Pool_5,
        oData          => oData_Pool_5
    );

    CNN_Convolution_9 : CNN_Convolution
    GENERIC MAP (
        Input_Columns  => Layer_9_Columns,
        Input_Rows     => Layer_9_Rows,
        Input_Values   => Layer_9_Values,
        Filter_Columns => Layer_9_Filter_X,
        Filter_Rows    => Layer_9_Filter_Y,
        Filters        => Layer_9_Filters,
        Strides        => Layer_9_Strides,
        Activation     => Layer_9_Activation,
        Padding        => Layer_9_Padding,
        Input_Cycles   => 64,
        Value_Cycles   => 64,
        Calc_Cycles    => 64,
        Filter_Cycles  => 64,
        ...
        Offset_Out     => Layer_9_Out_Offset, 
        Offset         => Layer_9_Offset,
        Weights        => Layer_9
    ) PORT MAP (
        iStream        => oStream_Pool_5,
        iData          => oData_Pool_5,
        oStream        => oStream_Conv_9,
        oData          => oData_Conv_9
    );

    PROCESS (oStream_Conv_9)
    BEGIN
        IF (rising_edge(oStream_Conv_9.Data_CLK)) THEN
            oCycle_Flat_1             <= (oStream_Conv_9.Row * Flatten_1_Columns + oStream_Conv_9.Column) * Flatten_1_Values + oStream_Conv_9.Filter;
            oStream_Flat_1.Data_Valid <= oStream_Conv_9.Data_Valid;
            oData_Flat_1              <= oData_Conv_9;
        END IF;
    END PROCESS;

    oStream_Flat_1.Data_CLK <= oStream_Conv_9.Data_CLK;
