...
module csi2_dphy_sys_csi2_rx_intel_vvp_ro_reg_servicer_2450_jflcrey
   (  clk,
      rst,
   ...
   localparam P_RO_REG_COUNT = 1 + 2;

   localparam integer P_RO_PARAMS [0 : P_RO_REG_COUNT-1] =  '{ P_VID_PID, P_VERSION_NUMBER, 0 };
