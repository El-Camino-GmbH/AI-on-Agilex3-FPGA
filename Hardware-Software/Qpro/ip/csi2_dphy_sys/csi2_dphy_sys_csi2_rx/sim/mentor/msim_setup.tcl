...
alias com {
  ...
  set common_design_files [dict values [csi2_dphy_sys_csi2_rx::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [csi2_dphy_sys_csi2_rx::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
