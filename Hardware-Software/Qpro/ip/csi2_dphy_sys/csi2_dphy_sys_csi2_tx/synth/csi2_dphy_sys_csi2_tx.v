...
module csi2_dphy_sys_csi2_tx (
	...
	csi2_dphy_sys_csi2_tx_intel_mipi_csi2_300_sjb35xa #(
		.ENABLE_SCRAMBLING        (0),
		.ENABLE_ECC               (1),
		.ENABLE_CRC               (1),
		.ENABLE_CSR               (1),
		...
		.tx_word_clk_hs_d0         (tx_word_clk_hs_d0),         //   input,   width = 1,                         d0_ppi_hs_clk.clk
		.tx_data_width_hs_d0       (tx_data_width_hs_d0),       //  output,   width = 2,                             d0_ppi_hs.TxDataWidthHS
		.tx_data_hs_d0             (tx_data_hs_d0),             //  output,  width = 16,                                      .TxDataHS
		.tx_word_valid_hs_d0       (tx_word_valid_hs_d0),       //  output,   width = 2,                                      .TxWordValidHS
		.tx_eq_active_hs_d0        (tx_eq_active_hs_d0),        //  output,   width = 1,                                      .TxEqActiveHS
		.tx_eq_level_hs_d0         (tx_eq_level_hs_d0),         //  output,   width = 1,                                      .TxEqLevelHS
		.tx_request_hs_d0          (tx_request_hs_d0),          //  output,   width = 1,                                      .TxRequestHS
		.tx_ready_hs_d0            (tx_ready_hs_d0),            //   input,   width = 1,                                      .TxReadyHS
		.tx_data_transfer_en_hs_d0 (tx_data_transfer_en_hs_d0), //  output,   width = 1,                                      .TxDataTransferEnHS
		.tx_skew_cal_hs_d0         (tx_skew_cal_hs_d0),         //  output,   width = 1,                                      .TxSkewCalHS
		.tx_alternate_cal_hs_d0    (tx_alternate_cal_hs_d0),    //  output,   width = 1,                                      .TxAlternateCalHS
		.tx_request_esc_d0         (tx_request_esc_d0),         //  output,   width = 1,                             d0_ppi_lp.TxRequestEsc
		.tx_request_type_esc_d0    (tx_request_type_esc_d0),    //  output,   width = 4,                                      .TxRequestTypeEsc
		.tx_lpdt_esc_d0            (tx_lpdt_esc_d0),            //  output,   width = 1,                                      .TxLpdtEsc
		.tx_ulps_exit_d0           (tx_ulps_exit_d0),           //  output,   width = 1,                                      .TxUlpsExit
		.tx_ulps_esc_d0            (tx_ulps_esc_d0),            //  output,   width = 1,                                      .TxUlpsEsc
		.tx_trigger_esc_d0         (tx_trigger_esc_d0),         //  output,   width = 4,                                      .TxTriggerEsc
		.tx_data_esc_d0            (tx_data_esc_d0),            //  output,   width = 8,                                      .TxDataEsc
		.tx_valid_esc_d0           (tx_valid_esc_d0),           //  output,   width = 1,                                      .TxValidEsc
		.tx_ready_esc_d0           (tx_ready_esc_d0),           //   input,   width = 1,                                      .TxReadyEsc
		...
		.tx_clk_esc_d0             (tx_clk_esc_d0),             //   input,   width = 1,                      d0_ppi_tx_lp_clk.clk
		.tx_word_clk_hs_d1         (tx_word_clk_hs_d1),         //   input,   width = 1,                         d1_ppi_hs_clk.clk
		.tx_data_width_hs_d1       (tx_data_width_hs_d1),       //  output,   width = 2,                             d1_ppi_hs.TxDataWidthHS
		.tx_data_hs_d1             (tx_data_hs_d1),             //  output,  width = 16,                                      .TxDataHS
		.tx_word_valid_hs_d1       (tx_word_valid_hs_d1),       //  output,   width = 2,                                      .TxWordValidHS
		.tx_eq_active_hs_d1        (tx_eq_active_hs_d1),        //  output,   width = 1,                                      .TxEqActiveHS
		.tx_eq_level_hs_d1         (tx_eq_level_hs_d1),         //  output,   width = 1,                                      .TxEqLevelHS
		.tx_request_hs_d1          (tx_request_hs_d1),          //  output,   width = 1,                                      .TxRequestHS
		.tx_ready_hs_d1            (tx_ready_hs_d1),            //   input,   width = 1,                                      .TxReadyHS
		.tx_data_transfer_en_hs_d1 (tx_data_transfer_en_hs_d1), //  output,   width = 1,                                      .TxDataTransferEnHS
		.tx_skew_cal_hs_d1         (tx_skew_cal_hs_d1),         //  output,   width = 1,                                      .TxSkewCalHS
		.tx_alternate_cal_hs_d1    (tx_alternate_cal_hs_d1),    //  output,   width = 1,                                      .TxAlternateCalHS
		.tx_request_esc_d1         (tx_request_esc_d1),         //  output,   width = 1,                             d1_ppi_lp.TxRequestEsc
		.tx_request_type_esc_d1    (tx_request_type_esc_d1),    //  output,   width = 4,                                      .TxRequestTypeEsc
		.tx_lpdt_esc_d1            (tx_lpdt_esc_d1),            //  output,   width = 1,                                      .TxLpdtEsc
		.tx_ulps_exit_d1           (tx_ulps_exit_d1),           //  output,   width = 1,                                      .TxUlpsExit
		.tx_ulps_esc_d1            (tx_ulps_esc_d1),            //  output,   width = 1,                                      .TxUlpsEsc
		.tx_trigger_esc_d1         (tx_trigger_esc_d1),         //  output,   width = 4,                                      .TxTriggerEsc
		.tx_data_esc_d1            (tx_data_esc_d1),            //  output,   width = 8,                                      .TxDataEsc
		.tx_valid_esc_d1           (tx_valid_esc_d1),           //  output,   width = 1,                                      .TxValidEsc
		.tx_ready_esc_d1           (tx_ready_esc_d1),           //   input,   width = 1,                                      .TxReadyEsc
		...
		.tx_clk_esc_d1             (tx_clk_esc_d1),             //   input,   width = 1,                      d1_ppi_tx_lp_clk.clk
		.tx_word_clk_hs_ck         (tx_word_clk_hs_ck),         //   input,   width = 1,                         ck_ppi_hs_clk.clk
		.tx_data_width_hs_ck       (tx_data_width_hs_ck),       //  output,   width = 2,                             ck_ppi_hs.TxDataWidthHS
		.tx_data_hs_ck             (tx_data_hs_ck),             //  output,  width = 16,                                      .TxDataHS
		.tx_word_valid_hs_ck       (tx_word_valid_hs_ck),       //  output,   width = 2,                                      .TxWordValidHS
		.tx_eq_active_hs_ck        (tx_eq_active_hs_ck),        //  output,   width = 1,                                      .TxEqActiveHS
		.tx_eq_level_hs_ck         (tx_eq_level_hs_ck),         //  output,   width = 1,                                      .TxEqLevelHS
		.tx_request_hs_ck          (tx_request_hs_ck),          //  output,   width = 1,                                      .TxRequestHS
		.tx_ready_hs_ck            (tx_ready_hs_ck),            //   input,   width = 1,                                      .TxReadyHS
		.tx_data_transfer_en_hs_ck (tx_data_transfer_en_hs_ck), //  output,   width = 1,                                      .TxDataTransferEnHS
		.tx_skew_cal_hs_ck         (tx_skew_cal_hs_ck),         //  output,   width = 1,                                      .TxSkewCalHS
		.tx_alternate_cal_hs_ck    (tx_alternate_cal_hs_ck),    //  output,   width = 1,                                      .TxAlternateCalHS
		.tx_request_esc_ck         (tx_request_esc_ck),         //  output,   width = 1,                             ck_ppi_lp.TxRequestEsc
		.tx_request_type_esc_ck    (tx_request_type_esc_ck),    //  output,   width = 4,                                      .TxRequestTypeEsc
		.tx_lpdt_esc_ck            (tx_lpdt_esc_ck),            //  output,   width = 1,                                      .TxLpdtEsc
		.tx_ulps_exit_ck           (tx_ulps_exit_ck),           //  output,   width = 1,                                      .TxUlpsExit
		.tx_ulps_esc_ck            (tx_ulps_esc_ck),            //  output,   width = 1,                                      .TxUlpsEsc
		.tx_trigger_esc_ck         (tx_trigger_esc_ck),         //  output,   width = 4,                                      .TxTriggerEsc
		.tx_data_esc_ck            (tx_data_esc_ck),            //  output,   width = 8,                                      .TxDataEsc
		.tx_valid_esc_ck           (tx_valid_esc_ck),           //  output,   width = 1,                                      .TxValidEsc
		.tx_ready_esc_ck           (tx_ready_esc_ck),           //   input,   width = 1,                                      .TxReadyEsc
		...
		.tx_clk_esc_ck             (tx_clk_esc_ck),             //   input,   width = 1,                      ck_ppi_tx_lp_clk.clk
		.axi4s_clk                 (axi4s_clk),                 //   input,   width = 1,                             axi4s_clk.clk
		.axi4s_rst                 (axi4s_rst),                 //   input,   width = 1,                             axi4s_rst.reset
		.axi4s_vid_in_0_tdata      (axi4s_vid_in_0_tdata),      //   input,  width = 48,           video_streaming_interface_0.tdata
