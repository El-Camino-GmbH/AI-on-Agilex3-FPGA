...
# ACDS 25.3 109 win32 2026.03.17.13:39:43
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     csi2_dphy_sys_rx_axi4s_clk_bridge
# 
...
# ----------------------------------------
# If csi2_dphy_sys_rx_axi4s_clk_bridge is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "csi2_dphy_sys_rx_axi4s_clk_bridge.csi2_dphy_sys_rx_axi4s_clk_bridge"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "C:/altera_pro/25.3/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [csi2_dphy_sys_rx_axi4s_clk_bridge::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [csi2_dphy_sys_rx_axi4s_clk_bridge::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [csi2_dphy_sys_rx_axi4s_clk_bridge::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [csi2_dphy_sys_rx_axi4s_clk_bridge::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [csi2_dphy_sys_rx_axi4s_clk_bridge::normalize_path "$file"]
  set normalized_dest [csi2_dphy_sys_rx_axi4s_clk_bridge::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [csi2_dphy_sys_rx_axi4s_clk_bridge::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [csi2_dphy_sys_rx_axi4s_clk_bridge::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [csi2_dphy_sys_rx_axi4s_clk_bridge::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [csi2_dphy_sys_rx_axi4s_clk_bridge::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
