...
module vvp_1d_lut_0_intel_vvp_1d_lut_algo_comp_2450_3h7a4ca #(
  ...
  import intel_vvp_1d_lut_pkg::*;

  localparam DEVICE_FAMILY              = "Agilex 3";
  localparam NUMBER_OF_COLOR_PLANES_IN  = 3;
  localparam NUMBER_OF_COLOR_PLANES_OUT = 3;
  localparam PIXELS_IN_PARALLEL         = 4;
  localparam MAX_WIDTH                  = 4096;
  localparam MAX_HEIGHT                 = 4096;
  localparam BPS_IN                     = 8;
  ...
  localparam BITS_LUT                   = 8;
  localparam EQUIDISTANT                = 1;
  localparam BITS_SEG                   = 8;
  localparam BITS_STEP                  = 2;
  localparam REVERSE_LUT                = 0;
  ...
  localparam SLAVE_ADDR_WIDTH = 10;
  ...
  input  logic [LUT_1D_CMD_PORT_WIDTH-1:0]  axi_st_cmd_tdata;

  output logic                                    axi_st_resp_tvalid;
  input  logic                                    axi_st_resp_tready;
  output logic [LUT_1D_RESP_PORT_WIDTH-1:0] axi_st_resp_tdata;
