...
module vvp_1d_lut_0_intel_vvp_ro_reg_servicer_2450_fuwl7my
   (  clk,
      rst,
   ...
   localparam integer P_RO_PARAMS [0 : P_RO_REG_COUNT-1] =  '{ P_VID_PID, P_VERSION_NUMBER, 1, 1, 8, 8, 3, 3, 4, 4096, 4096, 1, 8, 8, 2, 0 };
