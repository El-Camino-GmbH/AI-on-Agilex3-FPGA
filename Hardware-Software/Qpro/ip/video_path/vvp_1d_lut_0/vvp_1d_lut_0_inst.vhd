	component vvp_1d_lut_0 is
		port (
			...
			av_mm_control_agent_address       : in  std_logic_vector(9 downto 0)  := (others => 'X'); -- address
	...
	end component vvp_1d_lut_0;

	u0 : component vvp_1d_lut_0
		port map (
