...
module vvp_csc_0_intel_vvp_ro_reg_servicer_2450_mq2xmnq
   (  clk,
      rst,
   ...
   localparam P_RO_REG_COUNT = 11 + 2;

   localparam integer P_RO_PARAMS [0 : P_RO_REG_COUNT-1] =  '{ P_VID_PID, P_VERSION_NUMBER, 1, 1, 8, 8, 8, 1, 2, 1, 10, 0, 1 };
