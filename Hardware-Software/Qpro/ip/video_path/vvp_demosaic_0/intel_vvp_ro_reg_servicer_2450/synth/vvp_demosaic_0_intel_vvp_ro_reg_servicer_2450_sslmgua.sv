...
module vvp_demosaic_0_intel_vvp_ro_reg_servicer_2450_sslmgua
   (  clk,
      rst,
   ...
   localparam P_RO_REG_COUNT = 9 + 2;

   localparam integer P_RO_PARAMS [0 : P_RO_REG_COUNT-1] =  '{ P_VID_PID, P_VERSION_NUMBER, 1, 1, 10, 8, 1, 3, 4, 8192, 8192 };
