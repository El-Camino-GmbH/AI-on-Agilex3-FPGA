// video_path_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_at5ox5y.v

// Generated using ACDS version 25.3 109

`timescale 1 ps / 1 ps
module video_path_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_at5ox5y #(
		...
		input  wire [5:0]   in_channel,        //          .channel,       Channel input port of Avalon Streaming Sink Interface
		...
		output wire [5:0]   out_channel        //          .channel,       Channel output port of Avalon Streaming Source Interface
	);
