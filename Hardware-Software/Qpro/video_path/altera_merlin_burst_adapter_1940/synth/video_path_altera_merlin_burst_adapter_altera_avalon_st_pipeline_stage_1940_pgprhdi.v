// video_path_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_pgprhdi.v

// Generated using ACDS version 25.3 109

`timescale 1 ps / 1 ps
module video_path_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_pgprhdi #(
		...
		input  wire [141:0] in_data,           //          .data,          Input Data port of Avalon Streaming Sink Interface
		input  wire [6:0]   in_channel,        //          .channel,       Channel input port of Avalon Streaming Sink Interface
		...
		output wire [141:0] out_data,          //          .data,          Output Data port of Avalon Streaming Source Interface
		output wire [6:0]   out_channel        //          .channel,       Channel output port of Avalon Streaming Source Interface
	);

	video_path_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
