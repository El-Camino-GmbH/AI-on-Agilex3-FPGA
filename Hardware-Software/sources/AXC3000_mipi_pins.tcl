...
set_location_assignment PIN_AJ29  -to CAMERA_SDA
set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to CAMERA_SDA
set_location_assignment PIN_AJ27  -to CAMERA_SCL
set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to CAMERA_SCL
